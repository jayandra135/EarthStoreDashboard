...
export default function Dashboard({ children }) {
  ...
  const userNavigation = [
    ...
    { name: "Sign out", href: "#", onClick: onLogout, click: true },
  ];
  const navigation = [
    { name: "Dashboard", to: "/", icon: HomeIcon, current: true },
    { name: "User", to: "/user", icon: UsersIcon, current: false },
    { name: "Category", to: "/category", icon: FolderIcon, current: false },
    {
      name: "SubCategory",
      to: "/subcategory",
      icon: CalendarIcon,
    ...
    { name: "Products", to: "/product", icon: CalendarIcon, current: false },
  ];
    ...
    <>
      <div className="bg-gray-100">
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 rounded-lg m-2">
            <div className="flex h-16 shrink-0 items-center gap-x-2 ">
              <img
                ...
                alt="Your Company"
              />
              <h1 className="text-white text-lg">EarthStore</h1>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
        ...
        <div className="flex flex-1 flex-col md:pl-64 min-h-screen">
          ...
          <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 shadow rounded-lg m-3 backdrop-blur-md bg-white">
            ...
            {/* Separator */}
            <div
              className="h-auto w-px bg-gray-900/10 lg:hidden"
              aria-hidden="true"
            />
